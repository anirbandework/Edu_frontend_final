...
class _ChatThreadScreenState extends State<ChatThreadScreen> {
              ...
              children: [
                ...
                Text(widget.counterpartOnline ? 'Online' : 'Offline',
                    style: AppTheme.bodySmall.copyWith(
                        color: widget.counterpartOnline ? AppTheme.success : AppTheme.neutral400)),
              ],
            ),
          ),
        ]),
  ...
  Widget _body() {
    ...
    if (_messages.isEmpty) {
      return Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Icon(Icons.chat_bubble_outline, size: 40, color: AppTheme.neutral400),
          const SizedBox(height: 12),
  ...
  Widget _bubble(Map<String, dynamic> m) {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isMine ? AppTheme.greenPrimary : Colors.white,
